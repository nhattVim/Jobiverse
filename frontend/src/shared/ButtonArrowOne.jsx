...
const ButtonArrowOne = ({ children, selectedPage }) => {
  return (
    <Link to={selectedPage} className="group/b flex items-center justify-center bg-blue text-white rounded-full py-2 pl-3 pr-2 font-semibold gap-2.5 hover:bg-yellow hover:text-black transition-all duration-500 ease-in-out">
      {children}
